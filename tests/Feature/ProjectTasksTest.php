...
class ProjectTasksTest extends TestCase
{
    ...
    public function a_task_can_be_updated() {
        ...
        $this->actingAs($project->owner) // i wonna act as the owner of that project
            ->patch($project->tasks[0]->path(), [ //now when i try to update it from outside, if we try to change the body and we want to set its completed status to true
            'body' => 'changed',
            'completed' => true
        ]);
